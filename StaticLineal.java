...
public class StaticLineal extends Application
{
	...
	private static final int				NUMBER_OF_CIRCLES		= 12; // Do not change this
	...
	public static void setCircles()
	{
		...
		Circle circle;
		// First batch
		circle = new Circle(100, Y_COORDINATE, CIRCLE_SIZE);
		canvas.getChildren().add(circle);
		circle = new Circle(120, Y_COORDINATE, CIRCLE_SIZE);
		canvas.getChildren().add(circle);
		circle = new Circle(140, Y_COORDINATE, CIRCLE_SIZE);
		canvas.getChildren().add(circle);
		circle = new Circle(150, Y_COORDINATE, CIRCLE_SIZE);
		canvas.getChildren().add(circle);
		// Second batch
		circle = new Circle(300, Y_COORDINATE, CIRCLE_SIZE);
		canvas.getChildren().add(circle);
		circle = new Circle(330, Y_COORDINATE, CIRCLE_SIZE);
		canvas.getChildren().add(circle);
		circle = new Circle(350, Y_COORDINATE, CIRCLE_SIZE);
		canvas.getChildren().add(circle);
		circle = new Circle(380, Y_COORDINATE, CIRCLE_SIZE);
		// Third batch
		canvas.getChildren().add(circle);
		circle = new Circle(570, Y_COORDINATE, CIRCLE_SIZE);
		canvas.getChildren().add(circle);
		circle = new Circle(600, Y_COORDINATE, CIRCLE_SIZE);
		canvas.getChildren().add(circle);
		circle = new Circle(620, Y_COORDINATE, CIRCLE_SIZE);
		canvas.getChildren().add(circle);
		circle = new Circle(650, Y_COORDINATE, CIRCLE_SIZE);
		canvas.getChildren().add(circle);
	}// end setCircles
	...
	public void start(Stage primaryStage) throws Exception
	{
		...
		// 4 is the number of times the clustering will be done
		kMeans(10);
